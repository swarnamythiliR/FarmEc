...
public class DonationNeederPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donation_needer_page);

        // initializing our edittext and button
        donarNameEdt = findViewById(R.id.farmername);
        donarMobilenoEdt = findViewById(R.id.farmermobileno);
        donarAddressEdt = findViewById(R.id.farmeraddress);
        donationAmountEdt=findViewById(R.id.amountneeded);
        ...
        databaseReference = firebaseDatabase.getReference("Money Seeking Farmer");
        ...
        submitDonation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) && TextUtils.isEmpty(phone) && TextUtils.isEmpty(address)&&TextUtils.isEmpty(amount)) {
                    ...
                    Toast.makeText(DonationNeederPage.this, "Please add some data.", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void addDatatoFirebase(String name, String phone, String address,String amount) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(DonationNeederPage.this, "data added", Toast.LENGTH_SHORT).show();
                Intent mainIntent=new Intent(DonationNeederPage.this, NeederFinal.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(DonationNeederPage.this, "Fail to add data " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
}