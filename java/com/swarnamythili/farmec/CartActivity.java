...
import com.swarnamythili.farmec.Model.Cart;
import com.swarnamythili.farmec.Prevalent.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                holder.txtProductPrice.setText("Price per kg = Rs."+model.getPrice());
                holder.txtProductName.setText(model.getPname());
                int a=Integer.parseInt(model.getPrice());
                int b=Integer.parseInt(model.getQuantity());
                int oneTyprProductTPrice = a*b;
