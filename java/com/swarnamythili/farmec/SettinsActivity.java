...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Buyer");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Buyer").child(Prevalent.currentOnlineUser.getPhone());
